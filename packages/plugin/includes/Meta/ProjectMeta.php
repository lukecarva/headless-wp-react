...
final class ProjectMeta {
	 ...
	 *
	 * `graphql_name` is the camelCase field name exposed by WPGraphQL.
	 *
	 * @return array<string, array{type:string, graphql_name:string, sanitize:callable, description:string}>
	 */
	public function definitions(): array {
		return array(
			...
			self::STACK    => array(
				...
				'graphql_name' => 'stack',
				'sanitize'     => 'sanitize_text_field',
				'description'  => __( 'Comma-separated technologies.', 'headless-portfolio' ),
			),
			self::REPO_URL => array(
				'type'         => 'string',
